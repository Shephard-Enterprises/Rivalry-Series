...
export default function Home({ onEnter }) {
  return <>
    ...
    <section className="matchup-card">
      <div className="card-topline"><p>NFL Week 1</p><span className="live-pill"><i /> Draft open</span></div>
      ...
      <div className="draft-panel"><div><span className="eyebrow">Week 1 draft</span><h3>The season starts here.</h3><p>Build a fresh roster and take the first step toward bragging rights.</p></div><button onClick={onEnter}>Enter draft <span>→</span></button></div>
    </section>
